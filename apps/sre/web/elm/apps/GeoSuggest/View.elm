module GeoSuggest.View exposing (view)
  ...
  let
    liClasses =
      if (Just index == selectedIndex) then
        ...
        "list__item onclick"
  in
    li [ class liClasses, attribute "data-place-id" prediction.place_id, onMouseDown (GetPlaceDetailsForNewSearch prediction.place_id) ]
